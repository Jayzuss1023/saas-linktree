...
interface DashboardMetricsProp {
  analytics: AnalyticsData;
}

function DashboardMetrics({ analytics }: DashboardMetricsProp) {
  ...
  const formatRefferer = (referrer: string | null) => {
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl border border-purple-200">
              ...
              <div>
                <p className="text-sm font-md text-purple-600 mb-1">
                  Unique Visitors
                </p>
              ...
              fallback={
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-2xl border border-green-200 opacity-75">
                  ...
                  <div>
                    ...
                    <p className="text-bold font-bold text-green-900/75">
                      Upgrade to Ultra
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 border border-green-200 rounded-2xl">
                <div className="flex items-center justify-between mb-4">
          ...
          {(analytics.topLinkTitle || analytics.topReferrer) && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {analytics.topLinkTitle && (
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 p-2 rounded-2xl border border-slate-200">
              ...
              {analytics.topReferrer && (
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-2xl border border-slate-200">
                  ...
                  <p className="text-slate-700 font-medium">
                    {formatRefferer(analytics.topReferrer)}
                  </p>
                </div>
              )}
            </div>
