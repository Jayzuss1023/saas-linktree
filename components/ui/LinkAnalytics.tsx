        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-gray-600">Link Analytics</h2>
                <p className="text-gray-600">
                  🔒 Upgade to unlock powerful insights
                </p>
              </div>
            </div>
  ...
  return (
    <div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl border border-purple-200">
                ...
                <div>
                  <p className="text-small font-medium text-purple-600 mb-1">
                    Unique Users
                  </p>
                ...
                fallback={
                  <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-2xl border border-green-200 opacity-75">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-green-700/75">
      ...
      {analytics.dailyData.length > 0 && (
        <div className="bg-gradient-br from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      🔒 Upgrade to Ultra to unlock analytics
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Click distribution by countries
                    </p>
                  </div>
                </div>
                  ...
                  {analytics.countryData.map((country) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 relative">
                          <div className="bg-gray-200 rounded-6 height-6 relative overflow-hidden">
                            <div className="bg-gradient-to-r from-green-500 to-emerald-600 h-full rounded-full transition-all duration-500" />
                            <div className="flex absolute inset-0 items-center px-3">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50 text-center">
              ...
              <p className="text-gray-600">
                Analytics data will appear here once the links start receiving
                clicks.
              </p>
            </div>
          </div>
