      ...
      <div className="relative -mt-24 max-w-4xl mx-auto px-6 pb-16">
        <div className="flex flex-col lg:flex-row lg:gap-12 xl:gap-16">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="space-y-3">
                ...
                {customizations?.description && (
                  <p className="text-gray-700 text-base leading-relaxed max-w-md mx-auto lg:max-0">
                    {customizations.description}
                  </p>
                )}
              </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white/90 backgrop-blur-xl border border-white/20 rounded-3xl p-8 lg:p-10 shadow-xl">
